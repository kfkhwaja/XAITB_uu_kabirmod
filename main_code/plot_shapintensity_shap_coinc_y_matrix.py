...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shapintensity_shap_coinc_y_matrix.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to plot the coincidence between the shap structures and the shap structures based in the intensity
in the whole domain:
...
plot_coin_folder = "shapintensity_shap_coin_y"
plot_coin_file   = "shapintensity_shap_coin_y"
...
# -----------------------------------------------------------------------------------------------------------------------
mat_comb = calc_coinc_mat(data_in={"mat_struc1":shap_struc.mat_struc,
                                   "mat_struc2":shap_intensity_struc.mat_struc})["mat_comb"]
