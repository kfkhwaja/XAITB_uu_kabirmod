...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_Q_chong_streak_shap_coinc_y.py
-------------------------------------------------------------------------------------------------------------------------
...
colormap    = "viridis"
colornum    = 6
fig_name    = "Coincidence_uv_chong_streak_shap"
dpi         = 200
struc1_lab  = "uv"
struc2_lab  = "chong"
struc3_lab  = "streak"
...
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.plot_coinc import plot_coinc_4struc
import os
...
file        = folders.uv_chong_streak_shap_file
...
plot_format_data = {"file":file,"folder":data_folder,"plot_folder":plot_folder,"xlabel":xlabel,
                    ...
                    "struc2_lab":struc2_lab,"struc3_lab":struc3_lab,"struc4_lab":struc4_lab,"linewidth":linewidth}
plot_coinc_4struc(data_in=plot_format_data)