...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shap_uw_vsign_coinc_y_matrix_add_uv.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to plot the coincidence of the shap structures defined as a streak of u and w and clasifying depending on
the values of the v:
...
figsize_y        = 5
colormap         = "viridis"
fig_name         = "shap_uw_vsign_quadrants_coinc_mat_add_streak"
plot_coin_folder = "shap_uw_vsign_quadrants_coinc_mat_add_streak"
dpi              = 200
...
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plot_coinc_mat_2color_withcontour(data_in={"struc":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
                                           ...
                                           "data_folder":data_folder,"cont_struc":streak_struc})