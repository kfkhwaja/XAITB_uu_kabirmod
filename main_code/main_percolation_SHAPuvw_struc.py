...
"""
-------------------------------------------------------------------------------------------------------------------------
main_percolation_SHAPuvw_struc.py
-------------------------------------------------------------------------------------------------------------------------
Created on Wed Mar 27 08:23:08 2024

@author: Andres Cremades Botella

Function to create the percolation of the SHAP structures in a field. In the function the grid-points
...
# Import Packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_functions.percolation import percolation_uvw
import os
...
percolation_uvw(data_in={"Hmin":Hmin,"Hmax":Hmax,"Hnum":Hnum,"data_struc":data_struc,"save_data":True,
