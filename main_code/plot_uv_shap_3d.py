...
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plotstruc3d_2struc(data_in={"struc1":uv_struc,"struc2":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,
...
plotstruc3d_2struc_separate(data_in={"struc1":uv_struc,"struc2":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,
                                     "ylabel":ylabel,"zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,
                                     "figsize_y":figsize_y,"colormap1":colormap1,"colormap2":colormap2,
