...
colormap    = "viridis"
colornum    = 4
fig_name    = "urms_urmspred"
fig_name2   = "uvabs_uvabspred"
dpi         = 200
# -----------------------------------------------------------------------------------------------------------------------
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.ploturms import ploturmssim_urmspred
import os
...
#     - file        : name of the file containing the rms velocity information
...
file_pred     = folders.urmspred_file
file_sim      = folders.urms_file
dy            = chd.dy
dx            = chd.dx
dz            = chd.dz
...
# Create the plot
# -----------------------------------------------------------------------------------------------------------------------
plot_format_data = {"file_sim":file_sim,"file_pred":file_pred,"folder":data_folder,"plot_folder":plot_folder,
                    "xlabel":xlabel,"ylabel":ylabel,"ylabel2":ylabel2,"fontsize":fontsize,"figsize_x":figsize_x,
                    "figsize_y":figsize_y,"colormap":colormap,"colornum":colornum,"fig_name":fig_name,
                    "fig_name2":fig_name2,"dpi":dpi,"dy":dy,"dx":dx,"dz":dz,"uvw_folder":uvw_folder,
                    "uvw_file":uvw_file,"L_x":L_x,"L_y":L_y,"L_z":L_z,"file_trj":file_trj,"rey":rey,"utau":utau}
ploturmssim_urmspred(data_in=plot_format_data)