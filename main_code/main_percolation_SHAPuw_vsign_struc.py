...
"""
-------------------------------------------------------------------------------------------------------------------------
main_percolation_SHAPuw_vsign_struc.py
-------------------------------------------------------------------------------------------------------------------------
Created on Wed Mar 27 08:23:08 2024

@author: Andres Cremades Botella

Function to create the percolation of the SHAP structures as streaks and classified as a function of the sign of
the SHAP v in a field. In the function the grid-points
...
# Import Packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_functions.percolation import percolation_uw_vsign
import os
...
data_struc     = {"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":0,"index":index,
                  ...
                  "folder":uv_folder,"file":uv_file,"padding":padding,"data_type":data_type,"nsamples":nsamples,
                  "SHAPrms_file":SHAPrms_file,"SHAPmean_file":SHAPmean_file}

percolation_uw_vsign(data_in={"Hmin":Hmin,"Hmax":Hmax,"Hnum":Hnum,"data_struc":data_struc,"save_data":True,
