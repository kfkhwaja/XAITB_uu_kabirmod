...
"""
-------------------------------------------------------------------------------------------------------------------------
calc_hunt_shap_coinc_y.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to calculate the volume occupied by the hunt vortices the shap and the coincidence as a function of y:
...
#     - hunt_shap_file   : file for saving the coincidence between hunt vortices and shap structures
# -----------------------------------------------------------------------------------------------------------------------
index            = 7000
Hperc            = 1.41
...
data_out = calc_coinc(data_in={"data_struc1":shap_struc,"data_struc2":hunt_struc,"save_data":True,
                               "calc_coin_file":hunt_shap_file,"folder":data_folder,"dy":dy,"dx":dx,"dz":dz,
