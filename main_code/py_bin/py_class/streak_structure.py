...
class streak_structure():
    ...
    def save_struc(self):
        ...
        try:
            ...
            print("dim_x cannot be saved",flush=True)
        try:
            hf.create_dataset('dim_z',data=self.structures.dim_z)
        except:
            print("dim_z cannot be saved",flush=True)
        try:
            hf.create_dataset('dim_y',data=self.structures.dim_y)
        except:
            print("dim_y cannot be saved",flush=True)
    ...
    def reconstruct_fromprevious(self,data_in={"previous_folder":"../../P125_21pi_vu_streak_aug",
        ...
        data_in : dict, optional
            ...
            The default is {"previous_folder":"../../P125_21pi_vu_streak_aug",
                            "previous_file":"P125_21pi_vu.$INDEX$.h5.streak_aug"}.
            Data:
    ...
    def divide_high_low(self):
        ...
        for index_struc in np.arange(max_struc):
            ...
            if struc_signu >= 0:
                ...
                type_struc = -1
            self.type[index_struc] = type_struc