...
colormap    = "viridis"
colornum    = 4
fig_namea   = "Coincidence_Q1_shap"
fig_nameb   = "Coincidence_Q2_shap"
fig_namec   = "Coincidence_Q3_shap"
fig_named   = "Coincidence_Q4_shap"
dpi         = 200
struc1_lab  = "SHAP"
struc2a_lab = "Q1"
struc2b_lab = "Q2"
...
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.plot_coinc import plot_coinc_type
import os
...
file        = file.replace(".txt","_type.txt")
...
plot_format_data = {"file":file,"folder":data_folder,"plot_folder":plot_folder,"xlabel":xlabel,
                    ...
                    "colormap":colormap,"colornum":colornum,"fig_namea":fig_namea,"fig_nameb":fig_nameb,
                    "fig_namec":fig_namec,"fig_named":fig_named,"dpi":dpi,"struc1_lab":struc1_lab,
                    "struc2a_lab":struc2a_lab,"struc2b_lab":struc2b_lab,"struc2c_lab":struc2c_lab,
                    "struc2d_lab":struc2d_lab,"linewidth":linewidth}
plot_coinc_type(data_in=plot_format_data)