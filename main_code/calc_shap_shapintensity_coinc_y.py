...
Function to calculate the volume occupied by the shap structures the shap based on the intensity
and the coincidence as a function of y:
...
#     - shap_shapintensity_file : file for saving the coincidence between shap and shap structures
# -----------------------------------------------------------------------------------------------------------------------
index                   = 7000
Hperc                   = 1.41
...
# Create the data of the shap structure
# -----------------------------------------------------------------------------------------------------------------------
shap_intensity_struc = shap_intensity_structure(data_in={"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,
...
data_out = calc_coinc(data_in={"data_struc1":shap_intensity_struc,"data_struc2":shap_struc,"save_data":True,
                               "calc_coin_file":shap_shapintensity_file,"folder":data_folder,"dy":dy,"dx":dx,"dz":dz,
