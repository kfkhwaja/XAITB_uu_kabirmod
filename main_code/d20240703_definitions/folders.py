...
# ----------------------------------------------------------------------------------------------------------------------
data_folder     = "../../P125_83pi_data/d20240703_Data"
...
# ----------------------------------------------------------------------------------------------------------------------
model_folder = "../../P125_83pi_data/d20240703_models"
model_write  = "trained_model_5285.h5"
model_read   = "trained_model_5285.h5"
# ----------------------------------------------------------------------------------------------------------------------
# Data for the plots:
#     - plot_folder : folder to store the plots
# ----------------------------------------------------------------------------------------------------------------------
plot_folder = "../../P125_83pi_data/d20240703_plots"
...
#                                using the intensities of the shap values
# ----------------------------------------------------------------------------------------------------------------------
uv_folder              = "../../P125_83pi_vu_Qstruc/"
uv_file                = "P125_83pi.$INDEX$.Q"
streak_folder          = "../../P125_83pi_vu_streakLow/"
streak_file            = "P125_83pi.$INDEX$.Lstreaks"
chong_folder           = "../../P125_83pi_vu_chongstruc/"
chong_file             = "P125_83pi.$INDEX$.Chong"
hunt_folder            = "../../P125_83pi_vu_huntstruc/"
hunt_file              = "P125_83pi_vu.$INDEX$.h5.hunt"
SHAPq_folder           = "../../d20240703_P125_83pi_vu_SHAPstruc/"
SHAPq_file             = "P125_83pi_nsample$NSAMPLES$.$INDEX$.struc"
SHAPq_uvw_folder       = "../../d20240703_P125_83pi_vu_SHAPstruc_uvw/"
SHAPq_uvw_file         = "P125_83pi_vu_nsample$NSAMPLES$.$INDEX$.h5.shap"
SHAPq_uw_vsign_folder  = "../../d20240703_P125_83pi_vu_SHAPstruc_uw_vsign/"
SHAPq_uw_vsign_file    = "P125_83pi_vu_nsample$NSAMPLES$.$INDEX$.h5.shap"
SHAPq_intensity_folder = "../../d20240703_P125_83pi_vu_SHAPstruc_intensity/"
SHAPq_intensity_file   = "P125_83pi_vu_nsample$NSAMPLES$.$INDEX$.h5.shap"
...
# ----------------------------------------------------------------------------------------------------------------------
shap_folder           = "../../SHAP_d20240703"
shap_file             = "P125_83pi_nsample$NSAMPLES$.$INDEX$.h5.shap"
shapseg_uv_folder     = "../../SHAPsegment_uv_d20240703"
shapseg_uv_file       = "P125_83pi_segment_uv.$INDEX$.h5.shap"
shapseg_chong_folder  = "../../SHAPsegment_uv_d20240703"
shapseg_chong_file    = "P125_83pi_segment_uv.$INDEX$.h5.shap"
shapseg_streak_folder = "../../SHAPsegment_uv_d20240703"
shapseg_streak_file   = "P125_83pi_segment_uv.$INDEX$.h5.shap"
