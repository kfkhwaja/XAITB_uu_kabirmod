...
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plotstruc3d_2struc(data_in={"struc1":chong_struc,"struc2":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,
...
plotstruc3d_2struc_separate(data_in={"struc1":chong_struc,"struc2":shap_struc,"plot_folder":plot_folder,
