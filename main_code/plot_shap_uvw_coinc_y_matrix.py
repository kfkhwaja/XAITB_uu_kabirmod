...
figsize_y        = 5
colormap         = "viridis"
fig_name         = "shap_uvw_quadrants_coinc_mat"
plot_coin_folder = "shap_uvw_quadrants_coinc_mat"
dpi              = 200
...
import os
from py_bin.py_plots.plot_coinc_mat_quadrants_uvw import plot_coinc_mat_11color
...
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plot_coinc_mat_11color(data_in={"struc":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
