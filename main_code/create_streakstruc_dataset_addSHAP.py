...
Function to add the shap values to the streak structure dataset. In the function the grid-points containing the
...
for ii in index_range:
    ...
    # -------------------------------------------------------------------------------------------------------------------
    streak_struc.add_SHAP(data_in={"nsamples":nsamples})
