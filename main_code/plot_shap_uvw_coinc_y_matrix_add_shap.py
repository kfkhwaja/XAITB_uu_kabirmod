...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shap_uvw_coinc_y_matrix_add_shap.py
-------------------------------------------------------------------------------------------------------------------------
...
figsize_y        = 5
colormap         = "viridis"
fig_name         = "shap_uvw_quadrants_coinc_mat_add_shap"
plot_coin_folder = "shap_uvw_quadrants_coinc_mat_add_shap"
dpi              = 200
...
from py_bin.py_class.shap_uvw_structure import shap_structure as shap_structure_uvw
import os
...
# -----------------------------------------------------------------------------------------------------------------------
shap_struc_uvw = shap_structure_uvw(data_in={"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,"index":index,
                                             "dx":dx,"dy":dy,"dz":dz,"L_x":L_x,"L_y":L_y,"L_z":L_z,"rey":rey,
                                             "utau":utau,"padding":padding,"data_folder":data_folder,
                                             "umean_file":umean_file,"urms_file":urms_file,"sym_quad":True,
                                             "filvol":filvol,"shap_folder":shap_folder,"shap_file":shap_file,
                                             "folder":SHAPq_uvw_folder,"file":SHAPq_uvw_file,"padding":padding,
                                             "data_type":data_type,"nsamples":nsamples,"SHAPrms_file":SHAPrms_file,
                                             "SHAPmean_file":SHAPmean_file})
shap_struc_uvw.read_struc()
shap_struc_uvw.read_struc_Q()

# -----------------------------------------------------------------------------------------------------------------------
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plot_coinc_mat_11color_withcontour(data_in={"struc":shap_struc_uvw,"plot_folder":plot_folder,"xlabel":xlabel,
                                            "ylabel":ylabel,"fontsize":fontsize,"figsize_x":figsize_x,
                                            "figsize_y":figsize_y,"colors_11":colors_11,"fig_name":fig_name,"dpi":dpi,
                                            "dy":dy,"dx":dx,"dz":dz,"uvw_folder":uvw_folder,"uvw_file":uvw_file,
                                            "L_x":L_x,"L_y":L_y,"L_z":L_z,"rey":rey,"utau":utau,"cmap_flag":False,
                                            "index_ii":index,"plot_coin_folder":plot_coin_folder,
                                            "calc_coin_shap_uvw":calc_coin_shap_uvw,"data_folder":data_folder,
                                            "cont_struc":shap_struc})