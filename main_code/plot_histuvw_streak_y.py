...
colornum         = 4
dpi              = 200
plot_fileu       = "hist_uy_streak"
plot_filev       = "hist_vy_streak"
plot_filew       = "hist_wy_streak"
bins             = 50
lev_min          = 1e-2
lev_delta        = None
linewidth        = 2
...
#     - streak_folder : folder of the shap structures
...
# Read the velocity
# -----------------------------------------------------------------------------------------------------------------------
velocity_data = read_velocity(data_in={"folder":uvw_folder,"file":uvw_file,"index":index,"dx":dx,"dy":dy,"dz":dz,
