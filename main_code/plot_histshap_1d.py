...
Function to plot the pdf of the SHAP values for a wall-normal distance:
...
# -----------------------------------------------------------------------------------------------------------------------
import os
from py_bin.py_plots.plot_hist_y import plot_hist_1d
...
shap_u     = shap_data["SHAP_u"][index_y,:,:]
shap_v     = shap_data["SHAP_v"][index_y,:,:]
shap_w     = shap_data["SHAP_w"][index_y,:,:]
...
y_h_struc   = flowfield.y_h[index_y]
yplus_struc = (1-abs(y_h_struc))*rey
ylabel      = ylabel + " $(y^+="+'{0:.2f}'.format(yplus_struc)+")$"
# -----------------------------------------------------------------------------------------------------------------------
# Plot the data
# -----------------------------------------------------------------------------------------------------------------------
plot_format_data = {"plot_folder":plot_folder,"plot_file":plot_file,"ylabel":ylabel,"xlabelu":xlabelu,
                    "xlabelv":xlabelv,"xlabelw":xlabelw,"xlabelm":xlabelm,"fontsize":fontsize,"figsize_x":figsize_x,
                    "figsize_y":figsize_y,"colormap":colormap,"colornum":colornum,"dpi":dpi,"uu":shap_u_arr,
                    "vv":shap_v_arr,"ww":shap_w_arr,"mm":shap_m_arr,"yplus_struc":yplus_struc,"bins":bins,
                    "lev_min":lev_min,"lev_delta":lev_delta}
plot_hist_1d(data_in=plot_format_data)