...
Function to create the hunt vortices file of the structures in a field. In the function the grid-points
...
# -----------------------------------------------------------------------------------------------------------------------
hunt_struc.reconstruct_fromprevious(data_in={"previous_folder":"../../P125_21pi_vu_hunt",
