...
"""
-------------------------------------------------------------------------------------------------------------------------
calc_chong_shapintensity_coinc_y.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to calculate the volume occupied by the chong vortices the shap based on the intensity
...
data_out = calc_coinc(data_in={"data_struc1":shap_struc,"data_struc2":chong_struc,"save_data":True,
                               "calc_coin_file":chong_shap_file,"folder":data_folder,"dy":dy,"dx":dx,"dz":dz,
