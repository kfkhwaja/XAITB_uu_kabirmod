...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_chong_shap_coinc_y_matrix.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to calculate the coincidence between the chong vortices the shap in the whole domain:
...
struc1_lab       = "SHAP"
struc2_lab       = "chong"
plot_coin_folder = "chong_shap_coin_y"
plot_coin_file   = "chong_shap_coin_y"
...
# -----------------------------------------------------------------------------------------------------------------------
mat_comb = calc_coinc_mat(data_in={"mat_struc1":shap_struc.mat_struc,"mat_struc2":chong_struc.mat_struc})["mat_comb"]
