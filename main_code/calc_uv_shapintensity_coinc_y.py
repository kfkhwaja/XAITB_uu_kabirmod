...
"""
-------------------------------------------------------------------------------------------------------------------------
calc_uv_shapintensity_coinc_y.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to calculate the volume occupied by the uv structures the shap based on the intensity
...
#     - streak_folder          : folder of the chong structures
#     - streak_file            : file of the chong structures
...
#     - streak_shap_file       : file for saving the coincidence between chong vortices and shap structures
# -----------------------------------------------------------------------------------------------------------------------
index                  = 7000
Hperc                  = 1.41
...
uv_shap_file           = uv_shap_file.replace("shap","shapintensity")
...
data_out = calc_coinc(data_in={"data_struc1":shap_struc,"data_struc2":uv_struc,"save_data":True,
