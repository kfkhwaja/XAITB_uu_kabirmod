...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shap_uw_vsign_coinc_y_matrix_add_shap.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to plot the coincidence of the shap structures defined as a shap of u and w and clasifying depending on
the values of the v:
...
xlabel           = "$x^+$"
ylabel           = "$z^+$"
ylabelbar        = "$V_i/V_{tot}$"
fontsize         = 18
figsize_x        = 7
figsize_y        = 5
colormap         = "viridis"
fig_name         = "shap_uw_vsign_quadrants_coinc_mat_add_shap"
plot_coin_folder = "shap_uw_vsign_quadrants_coinc_mat_add_shap"
dpi              = 200
colors_2         = ['#1f77b4',  # Blue
                    '#ff7f0e',  # Orange
                    ]
...
from py_bin.py_class.shap_uw_vsign_structure import shap_structure as shap_structure_uw_vsign
import os
from py_bin.py_plots.plot_coinc_mat_quadrants_uw_vsign import plot_coinc_mat_2color_withcontour
...
# -----------------------------------------------------------------------------------------------------------------------
shap_struc = shap_structure(data_in={"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,"index":index,
                                         ...
                                         "shap_folder":shap_folder,"shap_file":shap_file,"folder":SHAPq_folder,
                                         "file":SHAPq_file,"padding":padding,"data_type":data_type,"nsamples":nsamples,
...
# -----------------------------------------------------------------------------------------------------------------------
shap_structure_uw_vsign = shap_structure_uw_vsign(data_in={"uvw_folder":uvw_folder,"uvw_file":uvw_file,
                                                           "Hperc":Hperc,"index":index,"dx":dx,
                                                           "dy":dy,"dz":dz,"L_x":L_x,"L_y":L_y,"L_z":L_z,
                                                           "rey":rey,"utau":utau,"padding":padding,
                                                           "data_folder":data_folder,"umean_file":umean_file,
                                                           "urms_file":urms_file,"sym_quad":True,"filvol":filvol,
                                                           "shap_folder":shap_folder,"shap_file":shap_file,
                                                           "folder":SHAPq_uw_vsign_folder,"file":SHAPq_uw_vsign_file,
                                                           "padding":padding,"data_type":data_type,"nsamples":nsamples,
                                                           "SHAPrms_file":SHAPrms_file,"SHAPmean_file":SHAPmean_file})
shap_structure_uw_vsign.read_struc()

# -----------------------------------------------------------------------------------------------------------------------
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plot_coinc_mat_2color_withcontour(data_in={"struc":shap_structure_uw_vsign,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
                                           "fontsize":fontsize,"figsize_x":figsize_x,"figsize_y":figsize_y,
                                           "colors_2":colors_2,"fig_name":fig_name,"dpi":dpi,"dy":dy,"dx":dx,"dz":dz,
                                           ...
                                           "data_folder":data_folder,"cont_struc":shap_struc})