...
"""
-------------------------------------------------------------------------------------------------------------------------
calc_shapintensity_uv_streak_chong_coinc_y.py
-------------------------------------------------------------------------------------------------------------------------
...
import os
from py_bin.py_functions.calc_coinc import calc_coinc_all_4types,save_coinc_all_4types
import numpy as np
...
#     - SHAPq_intensity_folder : folder of the shap structures
#     - SHAPq_intensity_file   : file of the uv structures
...
# -----------------------------------------------------------------------------------------------------------------------
shap_data = {"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,
             ...
             "folder":SHAPq_folder,"file":SHAPq_file,"padding":padding,
             "data_type":data_type,"nsamples":nsamples,
...
for ii in index_range:
    ...
    data_out = calc_coinc_all_4types(data_in={"data_struc1":shap_struc,"data_struc2":uv_struc,"data_struc3":streak_struc,
                                              "data_struc4":chong_struc,"save_data":False,
                                              "calc_coin_file":calc_coin_tot,"folder":data_folder,"dy":dy,"dx":dx,"dz":dz,
...
save_coinc_all_4types(data_in={"frac_coinc_tot":frac_coinc_tot,"yplus":yplus,"calc_coin_file":calc_coin_tot,
                               "folder":data_folder})