...
import os
from py_bin.py_functions.calc_coinc import calc_coinc_all_4types
...
SHAPmean_file          = folders.SHAPrms_file
...
data_out = calc_coinc_all_4types(data_in={"data_struc1":shap_struc,"data_struc2":uv_struc,
                                          "data_struc3":streak_struc,"data_struc4":chong_struc,"save_data":True,
