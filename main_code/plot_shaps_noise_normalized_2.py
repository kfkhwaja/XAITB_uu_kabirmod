...
from py_bin.py_plots.plotshap import plotshap_noise_normalized_2
...
# -----------------------------------------------------------------------------------------------------------------------
fields      = "_100"
nfield      = "101 field for computing SHAP"
xlabel      = "$x^+$"
ylabel      = "$z^+$"
titles      = ["$u^+$","$\phi$"]
fontsize    = 18
...
colormap    = "viridis"
colornum    = 3
fig_name    = "shapfield2_noise_normalized"+fields
dpi         = 200
index_ii    = 20000
index_y     = 20
ymin        = 0
...
errmin      = 0
b_velo_u    = "$u^+$"
b_shap_u    = "$\sqrt{|\phi_u|/|\phi_u|_{max}}$"
b_velo_v    = "$v^+$"
b_shap_v    = "$\sqrt{|\phi_v|/|\phi_v|_{max}}$"
b_velo_w    = "$w^+$"
b_shap_w    = "$\sqrt{|\phi_w|/|\phi_w|_{max}}$"
b_velo_m    = "$|u|^+$"
b_shap_m    = "$\sqrt{|\phi|/|\phi|_{max}}$"
scale_shap  = 1e5
colormapsh  = 'PRGn'
...
data_plot={"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,"fontsize":fontsize,"figsize_x":figsize_x,
           ...
           "nfield":nfield}
plotshap_noise_normalized_2(data_in=data_plot)