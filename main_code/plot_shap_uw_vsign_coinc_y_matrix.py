...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shap_uw_vsign_coinc_y_matrix.py
-------------------------------------------------------------------------------------------------------------------------
...
figsize_y        = 5
colormap         = "viridis"
fig_name         = "shap_uw_vsign_quadrants_coinc_mat"
plot_coin_folder = "shap_uw_vsign_quadrants_coinc_mat"
dpi              = 200
...
import os
from py_bin.py_plots.plot_coinc_mat_quadrants_uw_vsign import plot_coinc_mat_2color
...
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plot_coinc_mat_2color(data_in={"struc":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
                               ...
                               "data_folder":data_folder,"ylabelbar":ylabelbar})