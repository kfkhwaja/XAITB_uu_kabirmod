...
data_out = calc_coinc(data_in={"data_struc1":uv_struc,"data_struc2":chong_struc,"save_data":True,
                               "calc_coin_file":chong_uv_file,"folder":data_folder,"dy":dy,"dx":dx,"dz":dz,
