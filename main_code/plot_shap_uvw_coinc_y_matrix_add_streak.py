...
figsize_y        = 5
colormap         = "viridis"
fig_name         = "shap_uvw_quadrants_coinc_mat_add_streak"
plot_coin_folder = "shap_uvw_quadrants_coinc_mat_add_streak"
dpi              = 200
...
streak_struc = streak_structure(data_in={"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,"index":index,
                                         ...
                                         "shap_file":shap_file,"folder":streak_folder,"file":streak_file,
