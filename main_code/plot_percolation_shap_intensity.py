...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_percolation_shap_intensity.py
-------------------------------------------------------------------------------------------------------------------------
...
colormap    = "viridis"
colornum    = 4
fig_name    = "percolation_shap_intensity"
dpi         = 200

# -----------------------------------------------------------------------------------------------------------------------
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.plotpercolation import plotpercolation
import os
...
file        = file.replace(".txt","_intensity.txt")
...
plotpercolation(data_in=plot_format_data)