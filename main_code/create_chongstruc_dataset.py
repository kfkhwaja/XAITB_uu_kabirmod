...
"""
-------------------------------------------------------------------------------------------------------------------------
create_chongstruc_dataset.py
-------------------------------------------------------------------------------------------------------------------------
Created on Wed Mar 27 08:23:08 2024

@author: Andres Cremades Botella

Function to create the chong vortices structure dataset. In the function the grid-points containing the
...
#     - chong_folder  : folder of the streaks
#     - chong_file    : file of the streaks
...
data_struc  = {"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,"index":[],"dx":dx,"dy":dx,"dz":dz,
               ...
               "shap_folder":shap_folder,"shap_file":shap_file,"folder":chong_folder,"file":chong_file,
...
for ii in index_range:
    data_struc["index"] = ii
    chong_struc         = chong_structure(data_in=data_struc)
    
    # -------------------------------------------------------------------------------------------------------------------
    # Create the matrix containing the points of the structures
    # -------------------------------------------------------------------------------------------------------------------
    chong_struc.reconstruct_fromprevious(data_in={"previous_folder":"../../P125_21pi_vu_chong",
