...
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.plotSHAPmean import plotSHAPmean, plotSHAPmean_noabs
import os
...
plotSHAPmean(data_in=plot_format_data)
plot_format_data_noabs = {"file":file,"folder":data_folder,"plot_folder":plot_folder,"xlabel":xlabel,
                          "ylabel":ylabel,"fontsize":fontsize,"figsize_x":figsize_x,"figsize_y":figsize_y,
                          "colormap":colormap,"colornum":colornum,"fig_name":fig_name+"_noabs","dpi":dpi,"dy":dy,"dx":dx,
                          "dz":dz,"uvw_folder":uvw_folder,"uvw_file":uvw_file,"L_x":L_x,"L_y":L_y,"L_z":L_z,
                          "file_trj":file_trj,"rey":rey,"utau":utau}
plotSHAPmean_noabs(data_in=plot_format_data_noabs)