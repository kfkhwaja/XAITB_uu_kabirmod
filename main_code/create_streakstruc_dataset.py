...
"""
-------------------------------------------------------------------------------------------------------------------------
create_streakstruc_dataset.py
-------------------------------------------------------------------------------------------------------------------------
Created on Wed Mar 27 08:23:08 2024

@author: Andres Cremades Botella

Function to create the streak structure dataset. In the function the grid-points containing the
...
for ii in index_range:
    ...
    # -------------------------------------------------------------------------------------------------------------------
    streak_struc.reconstruct_fromprevious(data_in={"previous_folder":"../../P125_21pi_vu_streak_aug",
                                                   "previous_file":"P125_21pi_vu.$INDEX$.h5.streak_aug"})
