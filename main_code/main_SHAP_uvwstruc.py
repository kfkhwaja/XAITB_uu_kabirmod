...
data_struc = {"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,"index":index,"dx":dx,"dy":dx,"dz":dz,
              ...
              "shap_folder":shap_folder,"shap_file":shap_file,"folder":SHAPq_uvw_folder,"file":SHAPq_uvw_file,
              "padding":padding,"data_type":data_type,"nsamples":nsamples,"SHAPrms_file":SHAPrms_file,
...
shap_struc.structure_Quadrant(data_in={"nsamples":nsamples})
