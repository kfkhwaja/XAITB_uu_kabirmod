...
colornum         = 4
dpi              = 400
plot_fileu       = "hist_uy_uv_83pi"
plot_filev       = "hist_vy_uv_83pi"
plot_filew       = "hist_wy_uv_83pi"
bins             = 100
lev_min          = 1e-3
lev_delta        = None
linewidth        = 3
...
for ii in index_range:  
    ...
    fileh5save.create_dataset('index',data=ii/len(index_range))
    fileh5save.close()
