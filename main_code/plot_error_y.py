...
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.ploterrory import ploterrory
import os
...
file        = folders.error_file
file        = file.replace(".txt","_y.txt")
dy          = chd.dy
dx          = chd.dx
dz          = chd.dz
...
plot_format_data = {"file":file,"folder":data_folder,"plot_folder":plot_folder,"xlabel":xlabel,
                    ...
                    "rey":rey,"utau":utau}
ploterrory(data_in=plot_format_data)