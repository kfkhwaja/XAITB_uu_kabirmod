...
Function to plot the coincidence of the shap structures defined as a chong of u and w and clasifying depending on
the values of the v:
...
figsize_y        = 5
colormap         = "viridis"
fig_name         = "shap_uw_vsign_quadrants_coinc_mat_add_chong"
plot_coin_folder = "shap_uw_vsign_quadrants_coinc_mat_add_chong"
dpi              = 200
