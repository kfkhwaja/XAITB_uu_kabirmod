...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shapintensity_streak_coinc_y_matrix.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to plot the coincidence between the shap structures and the streak structures based in the intensity
in the whole domain:
...
plot_coin_folder = "shapintensity_streak_coin_y"
plot_coin_file   = "shapintensity_streak_coin_y"
...
# -----------------------------------------------------------------------------------------------------------------------
mat_comb = calc_coinc_mat(data_in={"mat_struc1":streak_struc.mat_struc,
