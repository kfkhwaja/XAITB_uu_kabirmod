...
figsize_y   = 5
colormap    = "viridis"
fig_name    = "shap3d_uw_vsign_quadrants"
dpi         = 200
...
import os
from py_bin.py_plots.plotstruc3d_quadrants_uw_vsign import plotstruc3d_2color, plotstruc3d_separe_2color
...
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plotstruc3d_2color(data_in={"struc":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
...
plotstruc3d_separe_2color(data_in={"struc":shap_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
                                    "zlabel":zlabel,"fontsize":fontsize,"figsize_x":figsize_x,"figsize_y":figsize_y,
                                    "colors_2":colors_2,"fig_name":fig_name,"dpi":dpi,"dy":dy,
