...
# ----------------------------------------------------------------------------------------------------------------------
folder_def  = "d20240524_definitions"
...
Training_data = {"ngpu":ngpu,"learat":learat,"optmom":optmom,"batch_size":batch_size,"field_ini":field_ini,
                 ...
                 "check":check,"tfrecord_train":tfrecord_train,"tfrecord_vali":tfrecord_vali,
                 "tfrecord_folder":tfrecord_folder,"flag_tfrecord":flag_tfrecord}
