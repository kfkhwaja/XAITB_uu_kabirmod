...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shapintensity_Q_streak_chong_hunt_coinc_y_matrix.py
-------------------------------------------------------------------------------------------------------------------------
...
from py_bin.py_plots.plot_coinc_mat import plot_coinc_mat_all_4types
...
struc3_lab       = "streak"
struc4_lab       = "chong"
plot_coin_folder = "shapintensity_Q_streak_chong_coin_y"
plot_coin_file   = "shapintensity_Q_streak_chong_coin_y"
...
calc_coin_tot          = folders.calc_coin_tot_4types
calc_coin_tot          = calc_coin_tot.replace("shap","shapintensity")
...
# -----------------------------------------------------------------------------------------------------------------------
shap_intensity_struc = shap_structure(data_in={"uvw_folder":uvw_folder,"uvw_file":uvw_file,"Hperc":Hperc,
...
# -----------------------------------------------------------------------------------------------------------------------
mat_comb = calc_coinc_mat_all_4types(data_in={"mat_struc1":shap_intensity_struc.mat_struc,
...
plot_format_data = {"plot_folder":plot_folder,"plot_coin_folder":plot_coin_folder,"plot_coin_file":plot_coin_file,
                    ...
                    "struc3_lab":struc3_lab,"struc4_lab":struc4_lab,
                    "flowfield":flowfield,"mat_comb":mat_comb,"index_ii":index,"calc_coin_tot":calc_coin_tot,
                    "data_folder":data_folder,"yminbar":yminbar,"ymaxbar":ymaxbar,"ynumbar":ynumbar,
                    "ylabelbar":ylabelbar}
plot_coinc_mat_all_4types(data_in=plot_format_data)