...
"""
-------------------------------------------------------------------------------------------------------------------------
create_chongstruc_dataset_addSHAP.py
-------------------------------------------------------------------------------------------------------------------------
Created on Wed Mar 27 08:23:08 2024

@author: Andres Cremades Botella

Function to add the shap values to the chong vortices structure dataset. In the function the grid-points containing the
...
for ii in index_range:
    ...
    # -------------------------------------------------------------------------------------------------------------------
    chong_struc.add_SHAP(data_in={"nsamples":nsamples})
