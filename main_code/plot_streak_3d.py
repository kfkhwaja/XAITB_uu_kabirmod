...
Function to plot the 3d streak structures:
...
# Plot the 3D field
# -----------------------------------------------------------------------------------------------------------------------
plotstruc3d(data_in={"struc":streak_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,"zlabel":zlabel,
...
plotstruc3d_separe(data_in={"struc":streak_struc,"plot_folder":plot_folder,"xlabel":xlabel,"ylabel":ylabel,
