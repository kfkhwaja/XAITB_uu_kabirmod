...
"""
-------------------------------------------------------------------------------------------------------------------------
calc_chong_uv_coinc_y.py
-------------------------------------------------------------------------------------------------------------------------
Created on Tue Jun 18 11:30:49 2024

@author: Andres Cremades Botella

Function to calculate the volume occupied by the chong vortices the shap and the coincidence as a function of y:
...
chong_uv_file    = folders.chong_uv_file
...
for ii in index_range:
    ...
    uv_struc.read_struc()
    data_out             = calc_coinc(data_in={"data_struc1":uv_struc,"data_struc2":chong_struc,"save_data":False,
                                               "calc_coin_file":chong_uv_file,"folder":data_folder,"dy":dy,"dx":dx,
...
save_coinc(data_in={"frac_struc1":frac_struc1,"frac_struc2":frac_struc2,"frac_coinc":frac_coinc,
                    "yplus":yplus,"calc_coin_file":chong_uv_file,"folder":data_folder})