...
"""
-------------------------------------------------------------------------------------------------------------------------
plot_shap_Q_streak_chong_hunt_coinc_y_matrix.py
-------------------------------------------------------------------------------------------------------------------------
...
import os
from py_bin.py_functions.calc_coinc import calc_coinc_mat_all
from py_bin.py_plots.plot_coinc_mat import plot_coinc_mat_all
...
struc4_lab       = "chong"
struc5_lab       = "hunt"
plot_coin_folder = "shap_Q_streak_chong_hunt_coin_y"
plot_coin_file   = "shap_Q_streak_chong_hunt_coin_y"
...
# -----------------------------------------------------------------------------------------------------------------------
mat_comb = calc_coinc_mat_all(data_in={"mat_struc1":shap_struc.mat_struc,"mat_struc2":uv_struc.mat_struc,
                                       "mat_struc3":streak_struc.mat_struc,"mat_struc4":chong_struc.mat_struc,
                                       "mat_struc5":hunt_struc.mat_struc})["mat_comb"]
...
plot_format_data = {"plot_folder":plot_folder,"plot_coin_folder":plot_coin_folder,"plot_coin_file":plot_coin_file,
                    ...
                    "struc3_lab":struc3_lab,"struc4_lab":struc4_lab,"struc5_lab":struc5_lab,
                    ...
                    "ylabelbar":ylabelbar}
plot_coinc_mat_all(data_in=plot_format_data)