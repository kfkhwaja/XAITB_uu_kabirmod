...
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.ploturms import ploturms
import os
...
if pred:
    file      = folders.urmspred_file
    fig_name  = fig_name+'_pred'
    fig_name2 = fig_name2+'_pred'
else:
    file      = folders.urms_file
dy            = chd.dy
dx            = chd.dx
dz            = chd.dz
...
ploturms(data_in=plot_format_data)