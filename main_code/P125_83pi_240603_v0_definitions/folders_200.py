...
#     - ssh_password      : password of the server
# ----------------------------------------------------------------------------------------------------------------------
uvw_folder_tf     = "../../../scratch/P125/tf/P125_83pi_tf_float32_minmaxnorm/"
uvw_folderii_tf   = 'P125_83pi.$INDEX$'
tfrecord_folder   = '../../../scratch/P125/tf/tfrecord/'
...
# ----------------------------------------------------------------------------------------------------------------------
model_folder = "../../../scratch/P125/models/"
model_write  = "trained_model_5284.h5"
model_read   = "trained_model_5284.h5"
# ----------------------------------------------------------------------------------------------------------------------
# Data for the plots:
#     - plot_folder : folder to store the plots
# ----------------------------------------------------------------------------------------------------------------------
plot_folder = "../../../scratch/P125/plots/"
...
#     - hunt_file     : file of the hunt vortices
# ----------------------------------------------------------------------------------------------------------------------
uv_folder        = "../../../scratch/P125/structures/uv/"
uv_file          = "P125_83pi.$INDEX$.h5.Q"
streak_folder    = "../../../scratch/P125/structures/streak/"
streak_file      = "P125_83pi.$INDEX$.h5.streak"
chong_folder     = "../../../scratch/P125/structures/chong/"
chong_file       = "P125_83pi.$INDEX$.h5.chong"
hunt_folder      = "../../../scratch/P125/structures/hunt/"
hunt_file        = "P125_83pi.$INDEX$.h5.hunt"
SHAPq_folder     = "../../../scratch/P125/structures/SHAPq/"
SHAPq_file       = "P125_83pi_nsample$NSAMPLES$.$INDEX$.h5.shap"
SHAPq_uvw_folder = "../../../scratch/P125/structures/SHAPuvw/"
...
#     - shap_file   : file to store the shap values
# ----------------------------------------------------------------------------------------------------------------------
shap_folder = "../../../scratch/P125/SHAP_d20240703_200"
