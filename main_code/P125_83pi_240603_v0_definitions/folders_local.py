...
tfrecord_folder   = '//lustre/scratch/serhocal@upvnet.upv.es/P125/tf/tfrecord/'
...
# ----------------------------------------------------------------------------------------------------------------------
model_folder = "/data1/P125/models/"
model_write  = "trained_model_5285.keras"
model_read   = "trained_model_5285.keras"
# ----------------------------------------------------------------------------------------------------------------------
# Data for the plots:
#     - plot_folder : folder to store the plots
# ----------------------------------------------------------------------------------------------------------------------
plot_folder = "/data1/P125/plots/"
...
#     - hunt_file     : file of the hunt vortices
# ----------------------------------------------------------------------------------------------------------------------
uv_folder        = "/data1/P125/P125_83pi_vu/Q/"
uv_file          = "P125_83pi.$INDEX$.Q"
streak_folder    = "/data1/P125/P125_83pi_vu/percStreaksLow/"
streak_file      = "P125_83pi.$INDEX$.Lstreaks"
chong_folder     = "/data1/P125/P125_83pi_vu/Chong/"
chong_file       = "P125_83pi.$INDEX$.Chong"
hunt_folder      = "/data1/P125/structures/hunt/"
hunt_file        = "P125_83pi.$INDEX$.h5.hunt"
SHAPq_folder     = "/data1/P125/P125_83pi_vu/SHAPq/"
SHAPq_file       = "P125_83pi_nsample$NSAMPLES$.$INDEX$.shap"
SHAPq_uvw_folder = "/data1/P125/structures/SHAPuvw/"
...
# ----------------------------------------------------------------------------------------------------------------------
shap_folder           = "../../../scratch/P125/SHAP_d20240703"
shap_file             = "P125_83pi_nsample$NSAMPLES$.$INDEX$.h5.shap"
shapseg_uv_folder     = "../../../scratch/P125/SHAPsegment_uv_d20240703"
shapseg_uv_file       = "P125_83pi_segment_uv.$INDEX$.h5.shap"
shapseg_chong_folder  = "../../../scratch/P125/SHAPsegment_chong_d20240703"
shapseg_chong_file    = "P125_83pi_segment_chong.$INDEX$.h5.shap"
shapseg_streak_folder = "../../../scratch/P125/SHAPsegment_streak_d20240703"
