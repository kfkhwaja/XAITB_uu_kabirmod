...
colormap    = "viridis"
colornum    = 4
fig_name    = "percolation_shap_uvw"
dpi         = 200

# -----------------------------------------------------------------------------------------------------------------------
# Import packages
# -----------------------------------------------------------------------------------------------------------------------
from py_bin.py_plots.plotpercolation import plotpercolation_uvw
import os
...
file        = file.replace(".txt","_uvw.txt")
...
plotpercolation_uvw(data_in=plot_format_data)